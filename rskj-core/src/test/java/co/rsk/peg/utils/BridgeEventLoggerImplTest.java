...
class BridgeEventLoggerImplTest {
    ...
    void setup() {
        ...
        eventLogger = new BridgeEventLoggerImpl(CONSTANTS, eventLogs, signatureCache);
    ...
    void logPeginBtc() {
        ...
        BridgeEventLogger eventLogger = new BridgeEventLoggerImpl(null, eventLogs, signatureCache);
